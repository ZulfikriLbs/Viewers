...
class ViewportOverlayCustom extends PureComponent {
  static propTypes = {
    ...
    const normal = (
      <React.Fragment>
        <div className="top-left overlay-element">
          ...
          <div>{patientId}</div>
          <div>Laki - Laki</div>
          <div>28 Tahun 6 Bulan 3 Hari</div>
        </div>
        <div className="top-right overlay-element">
          <div>{studyDescription}</div>
          <div>
            {formatDA(studyDate)} {formatTM('010101000')}
          </div>
        </div>
...
export default ViewportOverlayCustom;
